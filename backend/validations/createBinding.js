...
const xboxOneInputs = ["Left stick", "Left stick click", "Left bumper", "View button", "Xbox button", "Menu button", "Right bumper", "Directional pad up", "Directional pad down", "Directional pad left", "Directional pad right", "Right stick", "Right stick click", "X button", "Y button", "A button", "B button"]
