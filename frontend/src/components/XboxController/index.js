...
//           <circle cx="25059" cy="15155" r="1217" fill="none" stroke="#49FB35"  id="X button" onClick={handleClick}></circle>
//           <circle cx="27521" cy="12797" r="1217" fill="none" id="Y button" stroke='#49FB35' onClick={(e) => handleClick(e)}></circle>
//           <circle cx="27431" cy="17333" r="1217" fill="none" id="A button" stroke='#49FB35' onClick={(e) => handleClick}></circle>
//           <circle cx="29909" cy="14975" r="1217" fill="none" id="B button" stroke='#49FB35' onClick={(e) => handleClick(e)}></circle>
